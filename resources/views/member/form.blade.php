 <div class="modal fade text-left" id="formModalMember" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
     aria-hidden="true">
                                                 ...
                                                 <div class="col-md-6 col-12">
                                                     <div class="form-group ">
                                                         ...
                                                         <input type="text" name="nama" id="nama" class="form-control"
                                                             placeholder="Nama Member" name="fname-column"
                                                 ...
                                                 <div class="col-md-6 col-12">
                                                     <div class="form-group ">
                                                         ...
                                                         <textarea name="alamat" id="alamat" class="form-control"
                                                             placeholder="Alamat" name="fname-column"
